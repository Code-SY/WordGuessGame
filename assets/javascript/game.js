...
var game = {
  ...
  init: function() {
    ...
    me.guessesRemainingElement = document.getElementById(
  ...
  update: function() {
    ...
    me.winsCountElement.innerHTML =
      me.winsCount + "&nbsp; / &nbsp;" + me.lossesCount;
    ...
    if (me.guessesRemainingCount === me.guessesCount) {
      ...
      var imageUrl =
        imagesBasePath +
        "pic" +
        (me.guessesCount - me.guessesRemainingCount) +
        ".jpeg";
      me.imageElement.src = imageUrl;
    }

    if (me.isWin) {
      me.wrongLettersElement.innerHTML =
        "<div>You won!</div><br><div style='font-size: 0.5em;'>Please press space bar to continue.</div>";
      me.wrongLettersElement.style.backgroundColor = "lightgreen";
    }
    if (me.isLost) {
      me.wrongLettersElement.innerHTML =
        "You lost!<br><p style='font-size: 0.5em;'>Please press space bar to continue.</p>";
